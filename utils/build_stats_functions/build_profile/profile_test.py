...
def test_get_data():
  f1 = '/usr/local/google/home/halseycamilla/pytest/build/utils/build_stats/testing_files/no_first_line.json'
  with pytest.raises(profile.MissingTopLevelError):
    profile.get_data(f1)
  no_tid = '/usr/local/google/home/halseycamilla/pytest/build/utils/build_stats/testing_files/no_thread_id.json'
  with pytest.raises(profile.IncorrectProfileFormatError):
    profile.get_data(no_tid)
  no_name = '/usr/local/google/home/halseycamilla/pytest/build/utils/build_stats/testing_files/no_event_name.json'
...
def test_get_percents():
  ...
  no_ts = '/usr/local/google/home/halseycamilla/pytest/build/utils/build_stats/testing_files/no_timestamp.json'
  with pytest.raises(profile.IncorrectProfileFormatError):
