...
docker run --rm -v ~/tmp/dockertests:/tf tf-exp-devel bats -T /user_tools/preliminary.bats
docker run --rm -v ~/tmp/dockertests:/tf tf-exp-devel /user_tools/build_tf.sh
